...
def main():
    ...
    write_ligand_traj(_cnfrs_list_vina, ligand,
                      os.path.join(configs['out'], '16mc_output_clusters_sort=vina.pdbqt'),
    ...
    write_ligand_traj(_cnfrs_list_deeprmsd, ligand,
                      os.path.join(configs['out'], '16mc_output_clusters_sort=deeprmsd.pdbqt'),
    ...
    write_ligand_traj(_cnfrs_list_deeprmsd_vina, ligand,
                      os.path.join(configs['out'], '16mc_output_clusters_sort=deeprmsd_vina-0.8.pdbqt'),
    ...
    write_ligand_traj(_cnfrs_list_deeprmsd_vina, ligand,
                      os.path.join(configs['out'], '16mc_output_clusters_sort=deeprmsd_vina-0.5.pdbqt'),
                      information={"DeepRmsd-vinaScore": _scores_deeprmsd_vina},
                      )
    time_end = time.time()
