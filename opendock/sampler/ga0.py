...
class GeneticAlgorithmSampler(BaseSampler):
        ...
        for sn_gen in range(n_gen):
            ...
            for sn_pair in range(0, self.n_pop, 2):
                ...
                for _p in [_p1, _p2]:
                    ...
                    #print("_chrom_decoded",_chrom_decoded)
            ...
            self.ligand_cnfrs_history_.append(torch.Tensor(_lig_cnfrs[0].detach().numpy()))
            self.ligand_scores_history_.append(best_chrom_fitness*-1)
            ...
            #print(" self.ligand_scores_history_:",self.ligand_scores_history_)
            print(f"[INFO] iter#{self.this_iter} {self.__class__.__name__}, fitness {best_chrom_fitness*-1}")
    ...
    def objective_func(self, x, **kwargs):
        ...
        **kwargs : dict
        ...
        #print("self.receptor.cnfrs_ ",self.receptor.cnfrs_ )
