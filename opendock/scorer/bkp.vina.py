...
from opendock.score.scoring_function import BaseScoringFunction
...
class VinaSF(BaseScoringFunction):
    ...
    def cal_intra_repulsion(self):
        """
        When the distance between two atoms in adjacent frames 
    ...
    def cal_vina(self):
        ...
        print("vina_dist ", vina_dist)
        print("rec_lig_atom_vdw_sum ", rec_lig_atom_vdw_sum)

        vina = VinaScoreCore(vina_dist, 
                             rec_lig_is_hydrophobic, 
                             rec_lig_is_hbond, 
                             rec_lig_atom_vdw_sum)
