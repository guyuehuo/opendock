...
class VinaSF(BaseScoringFunction):
    ...
    def _prepare_data(self):
        ...
        print('len(rec_atom_indices_list)',len(rec_atom_indices_list))
        #print('len( lig_atom_indices_list)', len( lig_atom_indices_list))
        for each_rec_indices, each_lig_indices in zip(rec_atom_indices_list,
            ...
            r_hydro, l_hydro, r_hbdonor, l_hbdonor, r_hbacceptor, l_hbacceptor=speedup.speedup(each_rec_indices,each_lig_indices,
                                                                                               rec_atom_is_hydrophobic_dict, lig_atom_is_hydrophobic_dict,
                                                                                               rec_atom_is_hbdonor_dict, lig_atom_is_hbdonor_dict,
                                                                                               rec_atom_is_hbacceptor_dict,lig_atom_is_hbacceptor_dict
                                                                                               )
            r_vdw=[self.vdw_radii_dict[self.rec_heavy_atoms_xs_types[i]] for i in each_rec_indices]
            l_vdw=[self.vdw_radii_dict[self.updated_lig_heavy_atoms_xs_types[i]] for i in each_lig_indices]
    ...
    def scoring(self):
        ...
        # print('分数：',self.vina_inter_energy + vina_intra_term)
